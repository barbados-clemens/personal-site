...
image: https://media.calebukle.com/uploads/
...
tags:
  ...
  - JavaScript
---
My custom widgets are built with the [Scriptable App](https://scriptable.app/). This app allows you to write JavaScript and access certain iOS native apis though JavaScript. Also, some how this app is free?? Crazy!
...
// Get the F1 calendar on your device and get the next event to display
...
async function createWidget(alt) {
  ...
  let w = new ListWidget()
  w.url = "https://f1.com"
// if I wanted a background image here is how to do that
...
async function loadCalendar(){
	...
	let cal = await Calendar.forEventsByTitle("f1calendar.com/download/f1-calendar_p1_p2_p3_q_gp.ics");
...
// 	
	...
	// get events from the calendar for the next 30 days. Probably should change to prevent empty events at some point
	...
	// Timezone stuff that I think works
// 	startTime
